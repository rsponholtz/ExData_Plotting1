...
gooddata$Global_reactive_power_kw <- (as.numeric(gooddata$Global_reactive_power)) / 500
...
plot(gooddata$DateTime,gooddata$Global_active_power_kw,ylab="Global Active Power",xlab="", type="l" )
plot(gooddata$DateTime,gooddata$Voltage,ylab="Voltage",xlab="datetime", type="l" )
...
plot(gooddata$DateTime,gooddata$Global_reactive_power_kw,ylab="Global_Reactive_Power",xlab="datetime", type="l" )
dev.off()